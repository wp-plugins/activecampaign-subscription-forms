...
1. Upload `activecampaign_subscribe.php` to the `/wp-content/plugins/` directory.
2. Activate the plugin through the 'Plugins' menu in WordPress.
3. Visit Appearance > Widgets and drag the "ActiveCampaign Subscription Form" widget to a sidebar.
4. Fill in your 1-2-All connection details, then hit Save.
5. Choose a subscription form to display, then hit Save again.

== Frequently Asked Questions ==

= How do I create subscription forms to use in WordPress? =

You need to be running ActiveCampaign's [email marketing software](http://www.activecampaign.com/email-marketing/) to use this widget. Create new subscriptions forms in the software by going to Integration > Subscription Forms, then they will appear in this widget.

= I get a "Connection failed" message. What does this mean? =

Please make sure that your login information is correct, and that you are using a version of ActiveCampaign Email Marketing that supports API actions for subscription forms (You need version 5.0.16 or above).
